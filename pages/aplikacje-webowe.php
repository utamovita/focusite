        ...
        <div class="container">
            ...
            <div class="benefits__box">
                <div class="benefits__type">
                    ...
                    <p class="benefits__type__description">Korzyści aplikacji internetowych to temat rzeka. Zapewniają komfort zarówno dla użytkownika jak i właściciela aplikacji. Możesz używać jej zdalnie, z jakiegokolwiek urządzenia przenośnego bez pobierania żadnego oprogramowania. Jedyny wymóg aby móc używać aplikacji to dostęp to internetu - co w dzisiejszych czasach jest nie jest żadną przeszkodą.</p>
                </div>
                <div class="benefits__type">
                    <h3 class="benefits__type__title"><span>Dedykowane rozwiązania</span></h3>
                    <p>Chcemy, żeby nasi klienci otrzymali produkt jakiego oczekują. Zanim zaczniemy pracę nad Twoją aplikacją, organizujemy spotkanie, na którym ustalamy szczegóły działania aplikacji i rozpisujemy brief. Wierzymy, że bez dobrej specyfikacji nie ma oczekiwanych efektów dlatego kładziemy na to nacisk, żeby klient był zadowolony z końcowego efektu.</p>
                </div>

                <div class="benefits__type">
                    <h3 class="benefits__type__title"><span>Technologie</span></h3>
                    <p class="benefits__type__description">W naszych aplikacjach używamy tylko sprawdzonych metod i technologii. Do obsługi baz danych używamy MySql oraz MongoDB, kod po stronie serwera jest napisany w Node.js lub PHP a po stronie klienta w HTML5, SCSS, React.js/jQuery. Wszystkie z wymienionych technologii to bezpieczne i sprawdzone na rynku rozwiązania, które cię nie zawiodą.</p>
                </div>
            </div>
