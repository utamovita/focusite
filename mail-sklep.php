<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $products_num = trim($_POST["products-num"]);
        ...
        if($blog == "yes")$email_content .=  "Blog : Tak\n\n";
        if($payments == "yes")$email_content .=  "Płatności elektroniczne : Tak\n\n";
        $email_content .=  "Ilość produktów : $products_num\n\n";
