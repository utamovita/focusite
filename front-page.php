...
<main>
    <section class="home-banner">
        <img src="<?php bloginfo('template_url'); ?>/img/home-wave-top.png" class="wave-top" alt="focusite fioletowa fala">
        <div class="container">
            <div class="row">
                ...
                <div class="lg-4 sm-12 img-box">
                    <img src="<?php bloginfo('template_url'); ?>/img/computers.png" alt="komputer">
                </div>
            </div>
        </div>
    </section>
...
<footer>
    <img src="<?php bloginfo('template_url'); ?>/img/home-wave-bottom.png" class="bottom-wave" alt="fala focusite">
    <div class="container">
        <img src="<?php bloginfo('template_url'); ?>/img/copywriter.png" alt="copywriter">
