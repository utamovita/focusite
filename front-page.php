...
<footer>
    ...
    <div class="container">
        ...
        <div class="lg-6 sm-6 xs-12 right">
            ...
            <div class="info">
                <ul>
                    <li class="email"><a href="mailto:support@focusite.pl" title="mail">office@localhost</a></li><li class="phone"><a href="tel:+48732009546" title="phone">+48 732 009 546</a></li>
                </ul>
            </div>
        </div>
    </div>
