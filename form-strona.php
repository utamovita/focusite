    ...
    <form id="website-form" method="POST" action="https://focusite.pl/wp-content/themes/focusite/mail-strona.php">
        ...
        <section>
            ...
            <div class="form-section">
                <div class="align-mid">
                    <p class="btn-switch">
                        <input type="radio" value="yes" id="cms-yes" name="cms"
                            class="btn-switch__radio btn-switch__radio_yes" />
                        <input type="radio" value="no" id="cms-no" name="cms"
                            class="btn-switch__radio btn-switch__radio_no" checked />
            ...
            <div class="form-section">
                <div class="align-mid">
                    <p class="btn-switch">
                        <input type="radio" value="yes" id="project-yes" name="project"
                            class="btn-switch__radio btn-switch__radio_yes" />
                        <input type="radio" value="no" id="project-no" name="project"
                            class="btn-switch__radio btn-switch__radio_no" checked />
            ...
            <div class="form-section">
                ...
                <div class="bar-container">
                    <div class="range-slider">
                        ...
                        <input id="rs-range-line" class="rs-range" type="range" value="1" min="1" max="15"
                            name="page-num">
                    </div>
            ...
            <div class="form-section">
                <div class="align-mid">
                    <p class="btn-switch">
                        <input type="radio" value="yes" id="logo-yes" name="logo"
                            class="btn-switch__radio btn-switch__radio_yes" />
                        <input type="radio" value="no" id="logo-no" name="logo"
                            class="btn-switch__radio btn-switch__radio_no" checked />
            ...
            <div class="form-section">
                <div class="align-mid">
                    <p class="btn-switch">
                        <input type="radio" value="yes" id="seo-yes" name="seo"
                            class="btn-switch__radio btn-switch__radio_yes" />
                        <input type="radio" value="no" id="seo-no" name="seo"
                            class="btn-switch__radio btn-switch__radio_no" checked />
        ...
        <section>
            ...
            <div class="form-section">
                <div class="align-mid">
                    <p class="btn-switch">
                        <input type="radio" value="yes" id="gmap-yes" name="gmap"
                            class="btn-switch__radio btn-switch__radio_yes" />
                        <input type="radio" value="no" id="gmap-no" name="gmap"
                            class="btn-switch__radio btn-switch__radio_no" checked />
            ...
            <div class="form-section">
                <div class="align-mid">
                    <p class="btn-switch">
                        <input type="radio" value="yes" id="contactForm-yes" name="contactForm"
                            class="btn-switch__radio btn-switch__radio_yes" />
                        <input type="radio" value="no" id="contactForm-no" name="contactForm"
                            class="btn-switch__radio btn-switch__radio_no" checked />
            ...
            <div class="form-section">
                <div class="align-mid">
                    <p class="btn-switch">
                        <input type="radio" value="yes" id="gallery-yes" name="gallery"
                            class="btn-switch__radio btn-switch__radio_yes" />
                        <input type="radio" value="no" id="gallery-no" name="gallery"
                            class="btn-switch__radio btn-switch__radio_no" checked />
            ...
            <div class="form-section">
                <div class="align-mid">
                    <p class="btn-switch">
                        <input type="radio" value="yes" id="slider-yes" name="slider"
                            class="btn-switch__radio btn-switch__radio_yes" />
                        <input type="radio" value="no" id="slider-no" name="slider"
                            class="btn-switch__radio btn-switch__radio_no" checked />
            ...
            <div class="form-section">
                <div class="align-mid">
                    <p class="btn-switch">
                        <input type="radio" value="yes" id="lang-yes" name="lang"
                            class="btn-switch__radio btn-switch__radio_yes" />
                        <input type="radio" value="no" id="lang-no" name="lang"
                            class="btn-switch__radio btn-switch__radio_no" checked />
        ...
        <section class="contact-form">
            ...
            <div class="form-section ">
                <div class="align-mid">
                    <p class="btn-switch company-switch">
                        <input type="radio" value="yes" id="company-yes" name="company"
                            class="btn-switch__radio btn-switch__radio_yes" />
                        <input type="radio" value="no" id="company-no" name="company"
                            class="btn-switch__radio btn-switch__radio_no" checked />
            ...
            <label class="checkbox-container">
                ...
                kontaktowym, w celu udzielenia odpowiedzi na przesłane przeze mnie zapytanie. <a class="privacy"
