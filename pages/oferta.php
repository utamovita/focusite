        ...
        <div class="container">
            <div class="row">
                ...
                <div class="lg-6 sm-12">
                    <img src="<?php bloginfo('template_url'); ?>/img/offer-laptop.png" class="laptop-img" alt="bezprzewodowy komputer">
    ...
    <section id="section3">
        <div class="container">
            <div class="row">
                ...
                <div class="lg-6 sm-12">
                    <img src="<?php bloginfo('template_url'); ?>/img/team.png" alt="team siedzący przy okrągłym stole">
                </div>
                <div class="btn-box">
